...
<div class="box">
            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $row->tem_lah.' / '.$row->tgl_lah ?></td>
            ...
            data-id_pr2="<?php echo $row->nik;?>"
             data-nama_pr2="<?php echo $row->nama;?>" 
             ></a> 
            </span>||</span>
            <a href="<?php echo base_url()?>index.php/sekertaris_pusat/karyawan/tambah/<?php echo $row->nik?>" class="glyphicon glyphicon-pencil edit-personil"
