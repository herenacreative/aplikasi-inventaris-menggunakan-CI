...
<div class="box">
            ...
            <div class="box-body table-responsive">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?php echo $no++?></td>
                  <td><a target="_blank" href="<?php  echo base_url()?>index.php/sekertaris_pusat/inventaris/edit_l/<?php echo $row->id_inventaris;?>"><?php echo $row->id_inventaris;?></a></td>
               ...
               <?php
				   if($row->stts=="REQUEST ACC"){
					   ?>
					  <span>
            <a href="<?php echo base_url()?>index.php/sekertaris_pusat/inventaris/edit/<?php echo $row->id_inventaris?>" class="glyphicon glyphicon-book edit-personil"
            ...
            ></a>
					   ...
					   <?php }
					   elseif($row->stts=="PENGEMBALIAN ACC"){?>
                        <a href="<?php echo base_url()?>index.php/sekertaris_pusat/inventaris/edit_k/<?php echo $row->id_inventaris?>" class="glyphicon glyphicon-book edit-personil"
    ...
    <div class="modal-content">
      ...
      <div class="modal-bodydelete">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <form class="form" action="<?php echo base_url()?>index.php/sekertaris_pusat/karyawan/deletekaryawan" method="post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
