...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
     ...
     <span class="logo-mini"><b><?php echo $log?></b><?php $level;?></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b><?php echo $log.' '.$level;?></b><?php $level;?></span>
    </a>
...
<?php echo $this->load->view($header);?>
    ...
    <section class="sidebar">
     ...
     <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>CABANG <?php  echo $this->session->userdata('nama_cabang');?></p>
  ...
  <footer class="main-footer">
    ...
    <strong><a >PT Demo PERSADA MANDIRI</a>.</strong> 
    JL. Hos Cokroaminoto Kawasan Bisnis CBD Blok A3 No. 19 Karang Tengah,Tangerang15157
Telp 021-7319597 <a>gp.mandiri@yahoo.com</a> – <a>gepe_em@yahoo.com</a> All rights
    reserved.
